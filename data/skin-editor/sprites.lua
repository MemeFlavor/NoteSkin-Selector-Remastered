...
makeLuaText('buttonThingyText', ('SAVE DATA JSON'):pad(1, ' '), 0, 120, calcPosY((630.5+660.5)/2, 0))
...
makeLuaSprite('buttonThingy', 'ui/buttons/save_button_thingy3', 10, calcPosY((630.5+640.5)/2, 0))
